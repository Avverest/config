-- Русская раскладка в normal/visual/operator-pending режимах.
--
-- Работает в два слоя:
--   1. 'langmap' — переводит кириллицу в латиницу для встроенных команд
--      (dd, w, p, точка-повтор). См. :h langmap.
--   2. дубликаты привязок ниже — для всего, что настроено через map().
--      langmap до них не достаёт, подробности в комментарии перед вторым слоём.
-- На insert-режим и командную строку не влияет — русский текст и :команды
-- набираются как обычно.
